...
def trainer_synapse(args, model, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            image_aug = pipline(image_batch)
            outputs, outputs2, p_o, p_a, z_o, z_a = model(image_batch, image_aug)
            ...
            loss_dice2 = dice_loss(outputs2, label_batch, softmax=True)

            loss = 0.6*loss_ce + 0.6*loss_dice + 0.4*loss_ce2 + 0.4*loss_dice2 + 0.01*loss_contrast
